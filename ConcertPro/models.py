...
PAS1 = 1
JOUR_VOULU = datetime.datetime.today()
...
def concerts_agenda(heures=HEURES1,pas=PAS1,jour=JOUR_VOULU):
    ...
    for concert in concerts():
        ...
        if datetime.timedelta(days=-(jour.weekday()+1))<date_debut-jour<datetime.timedelta(days=7-(jour.weekday()+1)+1):
            for h in heures:
